...
**Erstellt Elexis_Artikelstamm_v4.xsd konforme Daten!** 

@Convert@ erstellt auf der Basis der "swissindex":http://www.refdata.ch Daten, welche mittels  @at.medevit.swissindex.client@ bezogen werden den Artikelstamm Datensatz (siehe @at.medevit.ch.artikelstamm@). 
