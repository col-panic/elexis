...
@XmlRootElement(name = "NONPHARMA")
public class NONPHARMA {

    @XmlElement(name = "ITEM")
    protected List<NONPHARMA.ITEM> item;
    @XmlElement(name = "RESULT")
    protected NONPHARMA.RESULT result;
     ...
     * 
     */
    public List<NONPHARMA.ITEM> getITEM() {
        if (item == null) {
            item = new ArrayList<NONPHARMA.ITEM>();
        }
        return this.item;
    }
     ...
     * @return
     *     possible object is
     *     {@link NONPHARMA.RESULT }
     *     
     */
    public NONPHARMA.RESULT getRESULT() {
        return result;
    }
     ...
     *     
     */
    public void setRESULT(NONPHARMA.RESULT value) {
        this.result = value;
    }
    ...
    public static class ITEM {
        ...
        protected NONPHARMA.ITEM.COMP comp;
         ...
         * @return
         *     possible object is
         *     {@link NONPHARMA.ITEM.COMP }
         *     
         */
        public NONPHARMA.ITEM.COMP getCOMP() {
            return comp;
        }
         ...
         *     
         */
        public void setCOMP(NONPHARMA.ITEM.COMP value) {
            this.comp = value;
        }
